...
$pdf->SetTitle('KP # 19 : NOTICE OF HEARING FOR RESPONDENT');
...
<div class="content-complainants">  
  <br>TO: <u>$respondent_last_name, $respondent_first_name $respondent_middle_name</u>
  <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Respondent
</div>
  
<div class="content" style="text-align: justify;">
<br>You are hereby required to appear me/the Pangkat on the _______ day of
____________, 19____, at __________ o’clock in the morning/afternoon to
explain why you failed to appear for mediation/conciliation scheduled on
____________, 19___ and why your counterclaim (if any) arising from the
